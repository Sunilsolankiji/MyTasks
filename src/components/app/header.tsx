...
export function Header({ onOpenTaskDialog }: HeaderProps) {
  return (
    <header className="sticky flex items-center justify-center top-0 z-10 w-full border-b border-gray-200 backdrop-blur-md bg-white/30 p-4 dark:border-gray-700 dark:bg-gray-800/30">
      <div className="container flex gap-6 justify-between items-center h-14">
        <a className="flex items-center space-x-2" href="/">
          ...
          <span className="font-bold sm:inline-block">MyTasks</span>
        </a>
