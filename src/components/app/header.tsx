...
export function Header({ projectName, onOpenTaskDialog, onOpenSettingsDialog }: HeaderProps) {
  return (
    <header className="sticky flex items-center justify-center top-0 z-20 w-full border-b border-gray-200 backdrop-blur-md bg-white/30 p-4 dark:border-gray-700 dark:bg-gray-800/30">
